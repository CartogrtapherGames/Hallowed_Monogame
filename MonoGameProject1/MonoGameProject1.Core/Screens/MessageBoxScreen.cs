...
namespace MonoGameProject1.Screens;
...
class MessageBoxScreen : GameScreen
{
  ...
  public override void HandleInput(GameTime gameTime, InputState inputState)
  {
    ...
    if (inputState.IsMenuSelect(ControllingPlayer, out playerIndex) || (MonoGameProject1Game.IsMobile && inputState.IsUIClicked(new Rectangle((int)yesButtonPosition.X, (int)yesButtonPosition.Y, (int)yesTextSize.X, (int)yesTextSize.Y))))
    {
    ...
    else if (inputState.IsMenuCancel(ControllingPlayer, out playerIndex) || (MonoGameProject1Game.IsMobile && inputState.IsUIClicked(new Rectangle((int)noButtonPosition.X, (int)noButtonPosition.Y, (int)noTextSize.X, (int)noTextSize.Y))))
    {
  ...
  public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
  {
    ...
    if (MonoGameProject1Game.IsMobile && !toastMessage)
    {
