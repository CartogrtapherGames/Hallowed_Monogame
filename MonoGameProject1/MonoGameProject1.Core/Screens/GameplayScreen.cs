...
partial class GameplayScreen : GameScreen
{
  ...
  public override void LoadContent()
  {
    ...
    leaderboardManager ??= ScreenManager.Game.Services.GetService<SettingsManager<MonoGameProject1Leaderboard>>();
  ...
  private string GetLevelStats(string messageTitle)
  {
    ...
    message +=
      ...
      level.TimeTaken +
      Environment.NewLine +
      Resources.GemsCollected +
      $": {level.GemsCollected:D2}/ {level.GemsCount:D2}";
  ...
  public override void HandleInput(GameTime gameTime, InputState inputState)
  {
    ...
    if (MonoGameProject1Game.IsMobile)
    {
    ...
    if (inputState.IsPauseGame(ControllingPlayer, backpackTouched) || gamePadDisconnected)
    {
