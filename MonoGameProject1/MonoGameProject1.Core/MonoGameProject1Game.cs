...
using MonoGameProject1.Core.Effects;
using MonoGameProject1.Core.Localization;
using MonoGameProject1.Core.Settings;
using MonoGameProject1.ScreenManagers;
using MonoGameProject1.Screens;
...
namespace MonoGameProject1.Core
{
  ...
  /// </remarks>}
  public class MonoGameProject1Game : Game
  {
    ...
    private SettingsManager<MonoGameProject1Settings> settingsManager;

    // Manages leaderboard data for tracking high scores and achievements.
    private SettingsManager<MonoGameProject1Leaderboard> leaderboardManager;
    ...
    public MonoGameProject1Game()
    {
      ...
      settingsManager = new SettingsManager<MonoGameProject1Settings>(storage);
      Services.AddService(typeof(SettingsManager<MonoGameProject1Settings>), settingsManager);

      leaderboardManager = new SettingsManager<MonoGameProject1Leaderboard>(storage);
      Services.AddService(typeof(SettingsManager<MonoGameProject1Leaderboard>), leaderboardManager);
